...
import { ShoppingCart, Heart, Search, Star, Clock, ShieldCheck, Truck, Dumbbell, ArrowRight, Check } from "lucide-react"
            ...
            <div className="max-w-4xl flex flex-col items-start gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-6">
                <Button
                  ...
                  asChild
                >
                  <Link href="/equipamentos">ALUGUE JÁ</Link>
                </Button>
                <Button
                  size="lg"
                  variant="outline"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              >
                <div className="aspect-square relative">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%20%281%29-OMD0pKKlttyPA3k029eEsCKLJfBbQK.png"
                  ...
                  <div className="absolute bottom-0 w-full p-4">
                    <h3 className="text-lg font-semibold text-white">Cardio</h3>
                    <p className="text-sm text-white/70">Equipamentos para treino cardiovascular</p>
              ...
              >
                <div className="aspect-square relative">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%20%284%29-EGokDMmq8AkpDjALz5kl8Uzwls7oZa.png"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
                  <div className="absolute bottom-0 w-full p-4">
                    <h3 className="text-lg font-semibold text-white">Musculação</h3>
                    <p className="text-sm text-white/70">Equipamentos para ganho de força</p>
                    <div className="mt-2 flex items-center text-primary text-sm font-medium">
                      Ver equipamentos <ArrowRight className="ml-1 h-3 w-3" />
                    </div>
                  </div>
              ...
              >
                <div className="aspect-square relative">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%20%286%29-wGAWYtOzNVnavK1POP0tbINBcPzKee.png"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
                  <div className="absolute bottom-0 w-full p-4">
                    <h3 className="text-lg font-semibold text-white">Funcional</h3>
                    <p className="text-sm text-white/70">Equipamentos para treino funcional</p>
                    <div className="mt-2 flex items-center text-primary text-sm font-medium">
                      Ver equipamentos <ArrowRight className="ml-1 h-3 w-3" />
                    </div>
                  </div>
              ...
              >
                <div className="aspect-square relative">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image%20%283%29-OYRV00Y2NknLMkUowz3qxPaqaIfELm.png"
                    alt="Corda de pular"
                    fill
                    className="object-cover transition-transform group-hover:scale-105"
                  />
                  ...
                  <div className="absolute bottom-0 w-full p-4">
                    ...
                    <p className="text-sm text-white/70">Complementos para seus treinos</p>
                    <div className="mt-2 flex items-center text-primary text-sm font-medium">
                      Ver equipamentos <ArrowRight className="ml-1 h-3 w-3" />
                    </div>
                  </div>
